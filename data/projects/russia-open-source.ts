...
export const russiaOpenSource: Project = {
  ...
  partners: [
    { logo: '/logos/yandex.svg', name: 'Яндекс', url: 'https://yandex.ru' },
    { logo: '/logos/basealt.svg', name: 'Basealt', url: 'https://www.basealt.ru' },
    { logo: '/logos/bellsoft.svg', name: 'Bellsoft', url: 'https://bell-sw.com' },
    { logo: '/logos/postgrespro.svg', name: 'PostgresPro', url: 'https://postgrespro.ru' },
    { logo: '/logos/huawei.svg', name: 'Huawei', url: 'https://www.huawei.com' },
    { logo: '/logos/redsoft.svg', name: 'Редсофт', url: 'https://red-soft.ru' },
    { logo: '/logos/krok.svg', name: 'КРОК', url: 'https://www.croc.ru' },
  ],
  gallery: [
