...
export const rbcVisionariesCommunity: Project = {
  id: 'rbc-visionaries-community',
  ...
  partners: [
    ...
    { logo: '/logos/mox.svg', name: 'MOX', url: '', width: 174, height: 99 },
    { logo: '/logos/wrf.svg', name: 'WRF', url: '', width: 140, height: 140 },
